...
public class AStarTrajectoryGenerator {
    ...
    public static Trajectory generateTrajectory(Path path) {
        ...
        TrajectoryConfig config = new TrajectoryConfig(Constants.Drive.HolonomicController.ThetaController.Constraints.MAX_VELOCITY, Constants.Drive.HolonomicController.ThetaController.Constraints.MAX_ACCELERATION);
        ...
        Pose2d end = new Pose2d(pathList.get(pathList.size())[0], pathList.get(pathList.size())[1], Rotation2d.fromDegrees(0));
