...
public final class Constants {
    ...
    public static class Drive {
        ...
        public static final Translation2d LOCATION_WHEEL_FRONT_LEFT = new Translation2d(Units.feetToMeters(10 + (7/8)), Units.feetToMeters(8 + (5/8)));
        public static final Translation2d LOCATION_WHEEL_FRONT_RIGHT = new Translation2d(Units.feetToMeters(10 + (7/8)), Units.feetToMeters(8 + (5/8)));
        public static final Translation2d LOCATION_WHEEL_REAR_LEFT = new Translation2d(Units.feetToMeters(10 + (7/8)), Units.feetToMeters(8 + (5/8)));
        public static final Translation2d LOCATION_WHEEL_REAR_RIGHT = new Translation2d(Units.feetToMeters(10 + (7/8)), Units.feetToMeters(8 + (5/8)));
