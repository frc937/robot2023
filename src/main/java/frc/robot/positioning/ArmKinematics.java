...
/**
 * Kinematics class contains forward and inverse kinematics functions for the 2023 robot arm. All
 * positions are measured relative to the base of the arm. Don't reuse, the math won't work for any
 * other arm.
 *
 * <p>If you want to implement this for a different design, these links describe how.
...
public final class ArmKinematics {
   ...
   *
   * @param baseRotation counter clockwise rotation of the arm base zeroed on the Y axis in degrees
   * @param shoulderRotation counter clockwise rotation of the shoulder about the X axis zeroed on
   *     the Z axis in degrees
   * @param armExtension distance in inches from the shoulder joint to the end of the grabber arm
   */
  ...
  /**
   * Returns whether the robot is stabbing itself. Keep in mind, this isn't 100% accurate, there
   * could be a last minute fix sticking up. How will you handle that? That sounds like a you
   * problem, not a me problem. Why are you hitting yourself? Why are you hitting yourself?
   *
  ...
  /**
   * Gets the arm extension to achieve a given end effector pose based at the bottom of the arm.
   * This doesn't take pose orientation into account.
   *
  ...
  /**
   * Gets the arm base rotation to achieve a given end effector pose based at the bottom of the arm.
   * This doesn't take pose orientation into account.
   *
   * @param target the desired pose
   */
  ...
  /**
   * Calculates the height of the robot in inches for the purpose of not overextending. This math
   * only works with vaguely rectangular robots.
   *
   * @param armPose the end effector pose being checked
   */
  ...
  /**
   * Gets the orientation of the end effector. Keep in mind that Rotation3d uses radians instead of
   * degrees.
   *
   * @param baseRotation counter clockwise rotation of the arm base zeroed on the Y axis in degrees
   * @param shoulderRotation counter clockwise rotation of the shoulder about the X axis zeroed on
  ...
  public static Rotation3d getOrientation(
      final double baseRotation, final double shoulderRotation, final double armExtension) {
  ...
  /**
   * Gets the shoulder rotation to achieve a given end effector pose based at the bottom of the arm.
   * This doesn't take pose orientation into account.
   *
   * @param target the desired pose
   */
