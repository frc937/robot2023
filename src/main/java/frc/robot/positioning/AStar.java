...
public class AStar {
     ...
     * The Heuristic is the estimated distance from the current node (not starting
     * node) to the (start||end) node.
     * 
     ...
     * @param v      Cost between 2 cells located horizontally or vertically next to
     *               each other
     * @param d      Cost between 2 cells located Diagonally next to each other
     * @return The Pathlist of Nodes.
     */
    private ArrayList<Node> generateHValue(boolean matrix[][], int startY, int startX, int endY, int endX, int width,
            int length, int v, int d) {
     ...
     * @return The Pathlist of Nodes.
     */
    private ArrayList<Node> generatePath(Node hValue[][], int startY, int startX, int endY, int endX, int x, int y,
            int v, int d) {
